...
const EXACT_TAXONOMY: Record<string, TagTaxonomy> = {
  ...
  blindfold: { step: 'appearance', subcategory: 'Explicit', majorGroup: 'Explicit Appearance', minorGroup: 'Intimate Apparel', groupOrder: 50, minorOrder: 20 },
  blindfolded: { step: 'appearance', subcategory: 'Explicit', majorGroup: 'Explicit Appearance', minorGroup: 'Intimate Apparel', groupOrder: 50, minorOrder: 20 },
  ...
  kinbaku: { step: 'action', subcategory: 'Explicit', majorGroup: 'Explicit Actions', minorGroup: 'Positions & Restraint', groupOrder: 50, minorOrder: 15 },
  ...
  'big tits': { step: 'appearance', subcategory: 'Explicit', majorGroup: 'Explicit Appearance', minorGroup: 'Erotic Anatomy', groupOrder: 50, minorOrder: 30 },
  cleavage: { step: 'appearance', subcategory: 'Explicit', majorGroup: 'Explicit Appearance', minorGroup: 'Nudity & Exposure', groupOrder: 50, minorOrder: 10 },
  ...
  'genital piercing': { step: 'appearance', subcategory: 'Explicit', majorGroup: 'Explicit Appearance', minorGroup: 'Erotic Anatomy', groupOrder: 50, minorOrder: 30 },
  'open crotch': { step: 'appearance', subcategory: 'Explicit', majorGroup: 'Explicit Appearance', minorGroup: 'Nudity & Exposure', groupOrder: 50, minorOrder: 10 },
  'exposing cleavage': { step: 'appearance', subcategory: 'Explicit', majorGroup: 'Explicit Appearance', minorGroup: 'Nudity & Exposure', groupOrder: 50, minorOrder: 10 },
  underboob: { step: 'appearance', subcategory: 'Explicit', majorGroup: 'Explicit Appearance', minorGroup: 'Nudity & Exposure', groupOrder: 50, minorOrder: 10 },
  'bikini tanlines': { step: 'appearance', subcategory: 'Explicit', majorGroup: 'Explicit Appearance', minorGroup: 'Grooming & Exposure', groupOrder: 50, minorOrder: 40 },
  ...
  'intimate apparel': { step: 'appearance', subcategory: 'Explicit', majorGroup: 'Explicit Appearance', minorGroup: 'Intimate Apparel', groupOrder: 50, minorOrder: 20 },
  'fitted intimates': { step: 'appearance', subcategory: 'Explicit', majorGroup: 'Explicit Appearance', minorGroup: 'Intimate Apparel', groupOrder: 50, minorOrder: 20 },
  'romantic atmosphere': { step: 'atmosphere', subcategory: 'Explicit', majorGroup: 'Intimacy & Explicit Tone', minorGroup: 'Private & Romantic', groupOrder: 50, minorOrder: 30 },
  'romantic intimacy': { step: 'atmosphere', subcategory: 'Explicit', majorGroup: 'Intimacy & Explicit Tone', minorGroup: 'Private & Romantic', groupOrder: 50, minorOrder: 30 },
  'affectionate chemistry': { step: 'atmosphere', subcategory: 'Explicit', majorGroup: 'Intimacy & Explicit Tone', minorGroup: 'Private & Romantic', groupOrder: 50, minorOrder: 30 },
  'tender closeness': { step: 'atmosphere', subcategory: 'Explicit', majorGroup: 'Intimacy & Explicit Tone', minorGroup: 'Private & Romantic', groupOrder: 50, minorOrder: 30 },
  'dominant vibe': { step: 'atmosphere', subcategory: 'Explicit', majorGroup: 'Intimacy & Explicit Tone', minorGroup: 'Seductive & Boudoir', groupOrder: 50, minorOrder: 10 },
  'submissive vibe': { step: 'atmosphere', subcategory: 'Explicit', majorGroup: 'Intimacy & Explicit Tone', minorGroup: 'Seductive & Boudoir', groupOrder: 50, minorOrder: 10 },
  'affectionate recovery moment': { step: 'atmosphere', subcategory: 'Explicit', majorGroup: 'Intimacy & Explicit Tone', minorGroup: 'Aftercare & Recovery', groupOrder: 50, minorOrder: 20 },
  'cozy affection': { step: 'atmosphere', subcategory: 'Explicit', majorGroup: 'Intimacy & Explicit Tone', minorGroup: 'Private & Romantic', groupOrder: 50, minorOrder: 30 },
  'submissive posture': { step: 'action', subcategory: 'Explicit', majorGroup: 'Explicit Actions', minorGroup: 'Positions & Restraint', groupOrder: 50, minorOrder: 15 },
  hogtie: { step: 'action', subcategory: 'Explicit', majorGroup: 'Explicit Actions', minorGroup: 'Positions & Restraint', groupOrder: 50, minorOrder: 15 },
  restrained: { step: 'action', subcategory: 'Explicit', majorGroup: 'Explicit Actions', minorGroup: 'Positions & Restraint', groupOrder: 50, minorOrder: 15 },
  'submissive sitting': { step: 'action', subcategory: 'Explicit', majorGroup: 'Explicit Actions', minorGroup: 'Positions & Restraint', groupOrder: 50, minorOrder: 15 },
  choking: { step: 'action', subcategory: 'Explicit', majorGroup: 'Explicit Actions', minorGroup: 'Erotic Touch', groupOrder: 50, minorOrder: 40 },
  spanking: { step: 'action', subcategory: 'Explicit', majorGroup: 'Explicit Actions', minorGroup: 'Erotic Touch', groupOrder: 50, minorOrder: 40 },
  'red marks on skin': { step: 'action', subcategory: 'Explicit', majorGroup: 'Explicit Actions', minorGroup: 'Erotic Touch', groupOrder: 50, minorOrder: 40 },
  slapping: { step: 'action', subcategory: 'Explicit', majorGroup: 'Explicit Actions', minorGroup: 'Erotic Touch', groupOrder: 50, minorOrder: 40 },
  'intricate rope binding': { step: 'appearance', subcategory: 'Explicit', majorGroup: 'Explicit Appearance', minorGroup: 'Intimate Apparel', groupOrder: 50, minorOrder: 20 },
  'decorative ropes': { step: 'appearance', subcategory: 'Explicit', majorGroup: 'Explicit Appearance', minorGroup: 'Intimate Apparel', groupOrder: 50, minorOrder: 20 },
  'submissive pet': { step: 'appearance', subcategory: 'Explicit', majorGroup: 'Explicit Appearance', minorGroup: 'Intimate Apparel', groupOrder: 50, minorOrder: 20 },
  'dominant female': { step: 'action', subcategory: 'Explicit', majorGroup: 'Explicit Actions', minorGroup: 'Erotic Touch', groupOrder: 50, minorOrder: 40 },
  'dominant riding': { step: 'action', subcategory: 'Explicit', majorGroup: 'Explicit Actions', minorGroup: 'Positions & Restraint', groupOrder: 50, minorOrder: 15 },
  dominant: { step: 'action', subcategory: 'Explicit', majorGroup: 'Explicit Actions', minorGroup: 'Erotic Touch', groupOrder: 50, minorOrder: 40 },
  'anonymous sex': { step: 'action', subcategory: 'Explicit', majorGroup: 'Explicit Actions', minorGroup: 'Sex Acts', groupOrder: 50, minorOrder: 10 },
  ...
  'straight angle': { step: 'setting', subcategory: 'Camera', majorGroup: 'Composition & Camera', minorGroup: 'Angles & Perspective', groupOrder: 10, minorOrder: 10 },
  'dutch angle': { step: 'setting', subcategory: 'Camera', majorGroup: 'Composition & Camera', minorGroup: 'Angles & Perspective', groupOrder: 10, minorOrder: 10 },
  'canted angle': { step: 'setting', subcategory: 'Camera', majorGroup: 'Composition & Camera', minorGroup: 'Angles & Perspective', groupOrder: 10, minorOrder: 10 },
  'isometric view': { step: 'setting', subcategory: 'Camera', majorGroup: 'Composition & Camera', minorGroup: 'Angles & Perspective', groupOrder: 10, minorOrder: 10 },
  'isometric perspective': { step: 'setting', subcategory: 'Camera', majorGroup: 'Composition & Camera', minorGroup: 'Angles & Perspective', groupOrder: 10, minorOrder: 10 },
  'first person view': { step: 'setting', subcategory: 'Camera', majorGroup: 'Composition & Camera', minorGroup: 'POV & Focus', groupOrder: 10, minorOrder: 30 },
  'point of view': { step: 'setting', subcategory: 'Camera', majorGroup: 'Composition & Camera', minorGroup: 'POV & Focus', groupOrder: 10, minorOrder: 30 },
  'depth of field': { step: 'setting', subcategory: 'Camera', majorGroup: 'Composition & Camera', minorGroup: 'POV & Focus', groupOrder: 10, minorOrder: 30 },
  'fisheye lens': { step: 'setting', subcategory: 'Camera', majorGroup: 'Composition & Camera', minorGroup: 'Angles & Perspective', groupOrder: 10, minorOrder: 10 },
  'wide angle': { step: 'setting', subcategory: 'Camera', majorGroup: 'Composition & Camera', minorGroup: 'Angles & Perspective', groupOrder: 10, minorOrder: 10 },
  'top down view': { step: 'setting', subcategory: 'Camera', majorGroup: 'Composition & Camera', minorGroup: 'Angles & Perspective', groupOrder: 10, minorOrder: 10 },
  'aerial view': { step: 'setting', subcategory: 'Camera', majorGroup: 'Composition & Camera', minorGroup: 'Angles & Perspective', groupOrder: 10, minorOrder: 10 },
  'low perspective': { step: 'setting', subcategory: 'Camera', majorGroup: 'Composition & Camera', minorGroup: 'Angles & Perspective', groupOrder: 10, minorOrder: 10 },
  japan: { step: 'setting', subcategory: 'Urban', majorGroup: 'Architecture & Urban', minorGroup: 'Landmarks & Travel', groupOrder: 20, minorOrder: 20 },
  'japanese architecture': { step: 'setting', subcategory: 'Urban', majorGroup: 'Architecture & Urban', minorGroup: 'Landmarks & Travel', groupOrder: 20, minorOrder: 20 },
  shibuya: { step: 'setting', subcategory: 'Urban', majorGroup: 'Architecture & Urban', minorGroup: 'Landmarks & Travel', groupOrder: 20, minorOrder: 20 },
  paris: { step: 'setting', subcategory: 'Urban', majorGroup: 'Architecture & Urban', minorGroup: 'Landmarks & Travel', groupOrder: 20, minorOrder: 20 },
  'french architecture': { step: 'setting', subcategory: 'Urban', majorGroup: 'Architecture & Urban', minorGroup: 'Landmarks & Travel', groupOrder: 20, minorOrder: 20 },
  'science fiction': { step: 'style', subcategory: 'Cinematic', majorGroup: 'Aesthetic & Genre', minorGroup: 'Epic & Genre', groupOrder: 20, minorOrder: 20 },
  'futuristic technology': { step: 'setting', subcategory: 'Sci-Fi', majorGroup: 'Fantasy & Specialty', minorGroup: 'Futuristic Worlds', groupOrder: 40, minorOrder: 30 },
  fog: { step: 'atmosphere', subcategory: 'Effects', majorGroup: 'Scene Effects', minorGroup: 'Fog, Smoke & Steam', groupOrder: 40, minorOrder: 10 },
  smoke: { step: 'atmosphere', subcategory: 'Effects', majorGroup: 'Scene Effects', minorGroup: 'Fog, Smoke & Steam', groupOrder: 40, minorOrder: 10 },
  fire: { step: 'atmosphere', subcategory: 'Effects', majorGroup: 'Scene Effects', minorGroup: 'Glow & Atmospherics', groupOrder: 40, minorOrder: 30 },
  bubbles: { step: 'atmosphere', subcategory: 'Effects', majorGroup: 'Scene Effects', minorGroup: 'Particles & Sparkles', groupOrder: 40, minorOrder: 20 },
  spring: { step: 'setting', subcategory: 'Outdoor', majorGroup: 'Nature & Outdoor', minorGroup: 'Weather & Seasons', groupOrder: 30, minorOrder: 40 },
  'conversational framing': { step: 'setting', subcategory: 'Scene', majorGroup: 'Scenes & Concepts', minorGroup: 'Subject Emphasis', groupOrder: 50, minorOrder: 20 },
  'overhead diorama view': { step: 'setting', subcategory: 'Camera', majorGroup: 'Composition & Camera', minorGroup: 'Angles & Perspective', groupOrder: 10, minorOrder: 10 },
  'high angle miniature feel': { step: 'setting', subcategory: 'Scene', majorGroup: 'Scenes & Concepts', minorGroup: 'Stylized Scene Concepts', groupOrder: 50, minorOrder: 40 },
  'hero low angle': { step: 'setting', subcategory: 'Camera', majorGroup: 'Composition & Camera', minorGroup: 'Angles & Perspective', groupOrder: 10, minorOrder: 10 },
